      ...
      builder: (context, themeState) {
        ...
        return StreamBuilder<MediaState>(
          ...
          builder: (context, snapshot) {
            ...
            final bool isOnline = extras["isOnline"] == true;
            final bool isDownloaded = extras["is_downloaded"] == true;

            final int? songId = isOnline
                ? null
                : isDownloaded
                ? extras["songId"] as int?
                : int.tryParse(mediaItem.id);
                ...
                builder: (context, state) {
                  return LiquidGlassLayer(
                    ...
                    settings: LiquidGlassSettings(
                      thickness: 30,
                      blur: isDesktop || !state.glassEnabled ? 10 : 1.5,
